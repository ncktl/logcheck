...
python_reindex = [
    'length', 'num_children', 'contains_class_definition',
...
java_reindex = [
    'length', 'num_children', 'contains_for_statement',
    ...
    'parent_argument_list',
    'parent_array_initializer',
    'parent_assignment_expression',
    'parent_binary_expression',
    'parent_cast_expression',
    'parent_expression_statement',
    'parent_field_access',
    'parent_method_invocation',
    'parent_method_reference',
    'parent_parenthesized_expression',
    'parent_resource',
    'parent_return_statement',
    'parent_ternary_expression',
