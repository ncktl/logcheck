...
from logcheck.extractors.python_extractor import PythonExtractor
from tree_sitter import Language, Tree, Node
from logcheck.extractors.extractor import print_children, traverse_sub_tree
...
class PythonAnalyzer(PythonExtractor):
    ...
    def analyze(self) -> list:
        ...
        recommendations = []
        classifier: LinearSVC = pickle.load(open('models/classifier', 'rb'))
